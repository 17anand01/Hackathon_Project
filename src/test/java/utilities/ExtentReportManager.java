...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		sparkReporter.config().setDocumentTitle("Travel Insurance Plan Report"); // Title of report
		sparkReporter.config().setReportName("Policybazaar Insurance Plan"); // name of the report
